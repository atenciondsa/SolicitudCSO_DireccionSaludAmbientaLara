...
const mapeoNombresPlantilla = {
  "Conformidad Sanitaria De Ocupación De Empresas, Colegios.docx":
    "Conformidad Sanitaria De Ocupación De Empresas, Colegios",
  "Conformidad Sanitaria De Perforación De Pozos.docx":
    "Conformidad Sanitaria De Perforación De Pozos",
  "Conformidad Sanitaria Para Variable Sanitarias De Sistemas De Tratamiento De Aguas Residuales Revisión.docx":
    "Conformidad Sanitaria Para Variable Sanitarias De Sistemas De Tratamiento De Aguas Residuales Revisión",
  "Conformidad Sanitaria De Contaminación Atmosférica.docx":
    "Conformidad Sanitaria De Contaminación Atmosférica",
  "Conformidad Sanitaria Para Camiones Cisterna.docx":
    "Conformidad Sanitaria Para Camiones Cisterna",
  "Conformidad Sanitaria De Ocupación Para Aplicadora Expendio Y Deposito Plaguicidas.docx":
    "Conformidad Sanitaria De Ocupación Para Aplicadora Expendio Y Deposito Plaguicidas",
  "Conformidad Sanitaria De Ocupación Para Granjas.docx":
    "Conformidad Sanitaria De Ocupación Para Granjas",
  "Conformidad Sanitaria De Ocupación Para Urbanismos Y Edificaciones.docx":
    "Conformidad Sanitaria De Ocupación Para Urbanismos Y Edificaciones",
  "Conformidad Sanitaria De Ocupación Para Unidades Vehiculares Que Transporten Desechos Generados En Establecimientos De Salud Y Desechos Cárnicos.docx":
  ...
  "Conformidad Sanitaria De Ocupación Para Unidades Vehiculares De Transporte Funerario.docx":
    "Conformidad Sanitaria De Ocupación Para Unidades Vehiculares De Transporte Funerario",
  "Conformidad Sanitaria De Permiso Del Uso Del Agua Proveniente De Pozo Perforado.docx":
    "Conformidad Sanitaria De Permiso Del Uso Del Agua Proveniente De Pozo Perforado",
  "Conformidad Sanitaria De Permiso De Operación De Sistemas De Tratamiento De Aguas Residuales.docx":
    "Conformidad Sanitaria De Permiso De Operación De Sistemas De Tratamiento De Aguas Residuales",
  "Conformidad Sanitaria Para Revisión De Proyectos De Urbanismo Y Edificaciones.docx":
    "Conformidad Sanitaria Para Revisión De Proyectos De Urbanismo Y Edificaciones",
  "Conformidad Sanitaria De Ocupación Para Dotación.docx":
    "Conformidad Sanitaria De Ocupación Para Dotación",
  "Conformidad Sanitaria de Revisión De Proyectos (Variables Sanitarias) De Equipos De Incineración Para Desechos Generados En Establecimiento De Salud.docx":
  ...
  "(DENUNCIAS) Requisitos Para Solicitud De Inspección Por Denuncias.docx":
    "(DENUNCIAS) Requisitos Para Solicitud De Inspección Por Denuncias",
  // NUEVOS: Salud Radiológica
  "Requisitos Salud Radiologica (Conformidad Sanitaria De Ambiente Radiologico).docx":
    "Conformidad Sanitaria De Ambiente Radiologico",
  "Requisitos Salud Radiologica (Conformidad Sanitaria De Funcionamiento Radiologico).docx":
    "Conformidad Sanitaria De Funcionamiento Radiologico",
  "Requisitos Salud Radiologica (Rimfri).docx":
...
function determinarTipoCSO(nombrePlantilla) {
  ...
  if (
    nombreUpper.includes("AMBIENTE RADIOLOGICO") ||
    nombreUpper.includes("AMBIENTE RADIOLÓGICO")
  ) {
    return "Conformidad Sanitaria De Ambiente Radiologico";
  }
  if (
    nombreUpper.includes("FUNCIONAMIENTO RADIOLOGICO") ||
    nombreUpper.includes("FUNCIONAMIENTO RADIOLÓGICO")
  ) {
  ...
  if (nombreUpper.includes("GRANJA"))
    return "Conformidad Sanitaria De Ocupación Para Granjas";
  if (nombreUpper.includes("VEHICULO") || nombreUpper.includes("TRANSPORTE")) {
    if (nombreUpper.includes("FUNERARIO"))
      return "Conformidad Sanitaria De Ocupación Para Unidades Vehiculares De Transporte Funerario";
  ...
  if (nombreUpper.includes("URBANISMO") || nombreUpper.includes("EDIFICACION"))
    return "Conformidad Sanitaria De Ocupación Para Urbanismos Y Edificaciones";
  if (nombreUpper.includes("AGUA") || nombreUpper.includes("RESIDUAL"))
    return "Conformidad Sanitaria De Permiso De Operación De Sistemas De Tratamiento De Aguas Residuales";
  if (nombreUpper.includes("POZO") && nombreUpper.includes("USO"))
    return "Conformidad Sanitaria De Permiso Del Uso Del Agua Proveniente De Pozo Perforado";
  if (
    nombreUpper.includes("PERFORACIÓN") ||
    nombreUpper.includes("PERFORACION")
  )
    return "Conformidad Sanitaria De Perforación De Pozos";
  if (nombreUpper.includes("CISTERNA"))
    return "Conformidad Sanitaria Para Camiones Cisterna";
  if (nombreUpper.includes("REVISION") || nombreUpper.includes("REVISIÓN"))
    return "Conformidad Sanitaria Para Revisión De Proyectos De Urbanismo Y Edificaciones";
  if (nombreUpper.includes("VARIABLE"))
    return "Conformidad Sanitaria Para Variable Sanitarias De Sistemas De Tratamiento De Aguas Residuales Revisión";
  if (
    nombreUpper.includes("ATMOSFERICA") ||
    nombreUpper.includes("ATMOSFÉRICA")
  )
    return "Conformidad Sanitaria De Contaminación Atmosférica";
  if (nombreUpper.includes("PLAGUICIDA"))
    return "Conformidad Sanitaria De Ocupación Para Aplicadora Expendio Y Deposito Plaguicidas";
  if (nombreUpper.includes("DOTACION") || nombreUpper.includes("DOTACIÓN"))
    return "Conformidad Sanitaria De Ocupación Para Dotación";
  if (nombreUpper.includes("DENUNCIA") || nombreUpper.includes("INSPECCIÓN"))
    return "(DENUNCIAS) Requisitos Para Solicitud De Inspección Por Denuncias";
  if (nombreUpper.includes("EMPRESAS") || nombreUpper.includes("COLEGIOS"))
    return "Conformidad Sanitaria De Ocupación De Empresas, Colegios";
  if (
    nombreUpper.includes("INCINERACIÓN") ||
    nombreUpper.includes("INCINERACION")
  )
    return "Conformidad Sanitaria de Revisión De Proyectos (Variables Sanitarias) De Equipos De Incineración Para Desechos Generados En Establecimiento De Salud";
...
const recaudosPorTipo = {
  "Conformidad Sanitaria De Ocupación Para Granjas": {
    ...
    lista: [
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
      "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
      ...
      "Al momento de retirar consignar el valor en timbres fiscales según Gaceta Ordinaria N° 26.232.",
    ],
  },
  "Conformidad Sanitaria De Ocupación Para Unidades Vehiculares Que Transporten Desechos Generados En Establecimientos De Salud Y Desechos Cárnicos":
    {
      titulo:
        "REQUISITOS PARA CONFORMIDAD SANITARIA DE OCUPACIÓN PARA UNIDADES VEHICULARES QUE TRANSPORTAN DESECHOS GENERADORES EN ESTABLECIMIENTO DE SALUD Y TRANSPORTES DE DESECHOS CÁRNICOS",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
        ...
        "Al momento de retirar consignar el valor en timbres fiscales según Gaceta Ordinaria N° 26.232.",
        "NOTA: La unidad vehicular deberá ser presentada previa planificación con la autoridad sanitaria de esta dirección para realizar la correspondiente inspección. Anexar un correo electrónico vigente.",
      ],
    },
  "Conformidad Sanitaria De Ocupación Para Unidades Vehiculares De Transporte Funerario":
    {
      titulo:
        "REQUISITOS PARA CONFORMIDAD SANITARIA DE OCUPACIÓN PARA UNIDADES VEHICULARES DE TRANSPORTE FUNERARIO",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria De Ocupación Para Urbanismos Y Edificaciones": {
    titulo:
      "REQUISITOS PARA CONFORMIDAD SANITARIA DE OCUPACIÓN PARA URBANISMOS Y EDIFICACIONES",
    lista: [
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
      "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con ganchos y separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria De Permiso De Operación De Sistemas De Tratamiento De Aguas Residuales":
    {
      titulo:
        "REQUISITOS PARA SOLICITAR EL PERMISO DE OPERACIÓN DE SISTEMAS DE TRATAMIENTO DE AGUAS RESIDUALES",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
        "Copia de cedula de identidad del representante legal de la razón social.",
  ...
  "Conformidad Sanitaria De Permiso Del Uso Del Agua Proveniente De Pozo Perforado":
    {
      titulo:
        "REQUISITOS PARA SOLICITAR EL PERMISO DEL USO DEL AGUA PROVENIENTE DE POZO PERFORADO",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con ganchos y separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria Para Camiones Cisterna": {
    titulo:
      "REQUISITOS PARA SOLICITAR POR PRIMERA VEZ AUTORIZACIÓN SANITARIA PARA CAMIONES CISTERNAS",
    lista: [
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
      "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con ganchos y separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria Para Revisión De Proyectos De Urbanismo Y Edificaciones":
    {
      titulo:
        "REQUISITOS PARA REVISIÓN DE PROYECTOS DE URBANISMO Y EDIFICACIONES (VARIABLES SANITARIAS)",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria Para Variable Sanitarias De Sistemas De Tratamiento De Aguas Residuales Revisión":
    {
      titulo:
        "REQUISITOS PARA SOLICITAR DEL PROYECTO (VARIABLE SANITARIAS) DE SISTEMAS DE TRATAMIENTO DE AGUAS RESIDUALES REVISIÓN",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con ganchos y separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria De Contaminación Atmosférica": {
    ...
    lista: [
      ...
      "Al momento de retirar consignar el valor en timbres fiscales según Gaceta Ordinaria N° 26.232.",
      "Resolución N° 132 (M.P.P.S) Gaceta Oficial N°39.807 de fecha 24 de noviembre de 2011",
      'Artículo 17: copia de la caracterización de emisiones consignada al Ministerio del poder popular para el Ambiente, según lo establecido en el art. 26 de la "Norma sobre calidad del aire y control de la contaminación atmosférica, publica en Gaceta Oficial N° 4.899 de fecha 19/05/95".',
      "Artículo 20: a los fines de renovar la autorización sanitaria, el interesado deberá presentar por ante la autoridad sanitaria ambiental competente la respectiva solicitud, ajustada a lo establecido en el art. 49 de la Ley Orgánica Procedimientos Administrativos y anexar copia de la caracterización de emisiones que su realización no sea mayor de 6 meses.",
    ],
  },
  "Conformidad Sanitaria De Ocupación Para Aplicadora Expendio Y Deposito Plaguicidas":
    {
      titulo:
        "REQUISITOS DE CONFORMIDAD SANITARIA DE OCUPACIÓN PARA APLICADORAS, EXPENDIO Y DEPÓSITOS DE PLAGUICIDAS",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
        ...
        "Copia del Registro mercantil de la empresa.",
        "Memoria Descriptiva (Datos generales de la empresa, dirección de oficina y deposito, N° trabajadores por género y por área, horario, objeto de la empresa, descripción de áreas con que cuenta, proceso o actividad, medidas de prevención y seguridad para el personal, productos y equipos) Listado de productos y equipos utilizados.",
  ...
  "Conformidad Sanitaria De Ocupación De Empresas, Colegios": {
    titulo: "REQUISITOS PARA CONFORMIDAD SANITARIA DE OCUPACIÓN DE EMPRESAS",
    lista: [
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
  ...
  "Conformidad Sanitaria De Perforación De Pozos": {
    titulo:
      "REQUISITOS DE CONFORMIDAD SANITARIA DE PERFORACIÓN DE POZOS, REALIZACIÓN DE SONDEOS O DE PERFORACIONES DE PRUEBA",
    lista: [
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
      "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria de Revisión De Proyectos (Variables Sanitarias) De Equipos De Incineración Para Desechos Generados En Establecimiento De Salud":
    {
      titulo:
        "REQUISITOS PARA SOLICITUD DE REVISIÓN DE PROYECTOS (VARIABLES SANITARIAS) DE EQUIPOS DE INCINERACIÓN PARA DESECHOS GENERADOS EN ESTABLECIMIENTO DE SALUD",
      lista: [
        "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
        "Consignar todos los documentos debidamente foliados en carpeta marrón tipo oficio con gancho, separadores. Anexar un correo electrónico vigente.",
  ...
  "Conformidad Sanitaria De Ambiente Radiologico": {
    ...
    tituloTabla:
      "REQUISITOS PARA CONFORMIDAD SANITARIA DE AMBIENTE RADIOLÓGICO",
    lista: [
      "Ordenar 2 carpetas con separadores debidamente identificados.",
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232)., con copia a la coordinación de salud radiológica.",
      "Copia de la cédula de identidad del representante legal. Anexar un correo electrónico vigente",
  ...
  "Conformidad Sanitaria De Funcionamiento Radiologico": {
    titulo:
      "REQUISITOS PARA CONFORMIDAD SANITARIA DE FUNCIONAMIENTO RADIOLÓGICO",
    tituloTabla:
      "REQUISITOS PARA CONFORMIDAD SANITARIA DE FUNCIONAMIENTO RADIOLÓGICO",
    lista: [
      ...
      "Presentación de la MEMORIA DESCRIPTIVA según capítulo 7 resolución nº 401 de fecha 24 de noviembre de 2006.",
      "MEMORIA DESCRIPTIVA QUE CONTENGA: Datos Administrativos: a. Datos de la Institución: Nombre, Dirección, Teléfono, Fax, Anexar un correo electrónico vigente b. Responsable de la Institución. c. Responsable del equipo. d. Profesional responsable del Servicio. e. Profesional responsable de la Protección Radiológica. f. Datos del Equipo: g. Tipo de equipo y sus características. (Según NVC 218/I vigente). h. Accesorios de protección que dispone el equipo. i. Período de garantía del equipo. j. Aplicaciones médicas. k. Documentación técnica del equipo (copia).",
  ...
  "Requisitos Para La Solicitud De RIMFRI": {
    ...
    lista: [
      ...
      "Presentar solicitud en papel simple dirigida a la Dra. Alexandra González, Directora de Salud Ambiental, acompañada de los timbres fiscales correspondientes (valor según la Gaceta Oficial Ordinaria N° 26.232).",
      "Planilla del RIMFRI.",
      "Fotocopia de la Cédula del representante legal. Anexar un correo electrónico vigente",
      "RIF. Vigente.",
      "DPCU.",
      "Registro mercantil.",
      "Factura de compra.",
...
function generarHTMLDocumento(datos, data, modoCompacto = false) {
  ...
  const esDotacion =
    data.titulo === "REQUISITOS PARA SOLICITUD DOTACIÓN SANITARIA";
  ...
  if (
    tituloTabla.includes("AMBIENTE RADIOLÓGICO") ||
    tituloTabla.includes("AMBIENTE RADIOLOGICO")
  ) {
    textoPermiso = "de la Conformidad Sanitaria de Ambiente Radiologico:";
  } else if (
    tituloTabla.includes("FUNCIONAMIENTO RADIOLÓGICO") ||
    tituloTabla.includes("FUNCIONAMIENTO RADIOLOGICO")
  ) {
...
<div class="container">
  ...
  <div class="declaracion-jurada">
    <strong>DECLARO BAJO JURAMENTO:</strong> Que cumplo con la norma sanitaria vigente en materia de
    infraestructura gaceta N° 4044 y otras que son requeridas para el presente tramite. La veracidad
    de la información suministrada y los documentos entregados en esta solicitud:
    <span class="line"></span>, son copia fiel y exacta de los originales los cuales pueden ser
    verificados en cualquier momento mediante <strong>inspección</strong>, y de probarse lo contrario, asumo la
    responsabilidad civil, penal y administrativa que corresponda. No me ha sido solicitado ningún
    pago o colaboración adicional a los timbres fiscales.
  </div>
...
async function generarCSOPDF(datosFormulario, nombrePlantilla) {
  ...
  if (!data) {
    ...
    alert(
      `Error: No se encontraron los requisitos para "${nombrePlantilla}". Se generará con el formato por defecto.`,
    );
    const dataDefault =
      recaudosPorTipo["Conformidad Sanitaria De Ocupación Para Granjas"];
...
async function generarPDFConDatos(datosFormulario, data) {
  ...
  console.log(
    `📊 Tipo: ${data.titulo.substring(0, 50)}... | Items: ${data.lista.length} | Modo compacto: ${modoCompacto}`,
  );

  const contenidoHTML = generarHTMLDocumento(
    datosFormulario,
    data,
    modoCompacto,
  );
  ...
  try {
    ...
    if (imgHeightMM > pageHeightMM) {
      ...
      yPositionMM = 0;
      console.log(
        `📄 Imagen más alta (${imgHeightMM.toFixed(1)}mm), escalando a ${finalHeightMM.toFixed(1)}mm`,
      );
